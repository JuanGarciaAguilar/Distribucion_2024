CREATE PROCEDURE [dbo].[distribucion_Stock_GetAll-Fechas]
...
--select @fechainicio = '2022-01-01'
--select @fechafinal = '2022-05-29'
	...
	---- Cantidad actual de stock|
		(SELECT DISTINCT
			...
			CantidadActualStock = (
				...
				WHERE
					S.[ProductId] = [ProductId] and  FechaStock between @fechainicio and @fechafinal
				ORDER BY
					[FechaStock] DESC
