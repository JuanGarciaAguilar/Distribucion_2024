            ...
            this._menu
                ...
                .subscribe((data: any) => {
                    ...
                    data.forEach((itemheader: any) => {
                        itemheader.items.forEach((itemchild: any) => {
                            if (itemchild.items.length === 0) {
                                delete itemchild.items;
                            } else {
                                itemchild.items.forEach((child: any) => {
                ...
                items: [
                    {
                        ...
                        icon: 'pi pi-fw pi-user',
                            : [
                            {
                                ...
                                routerLink: ['/ControlInterno/Versiones'],
                                items: []
                            },
                        ],
                    },
                        ...
                        items: [
                            {
                                label: 'Servidores',
                                icon: 'pi pi-fw pi-sign-in',
                                routerLink: ['/ControlInterno/Servidores'],
                            },
                            {
                                label: 'Perfiles',
                                icon: 'pi pi-fw pi-sign-in',
                                routerLink: ['/ControlInterno/Perfiles'],
                            },
                        ],
